...
import (
	...
	"github.com/teslapatrick/RPOC/internal/build"
	"github.com/teslapatrick/RPOC/params"
	sv "github.com/teslapatrick/RPOC/swarm/version"
)
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/teslapatrick/RPOC/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "--tags", "ios", "-v", "github.com/teslapatrick/RPOC/mobile")
